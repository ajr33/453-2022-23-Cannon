...
#define LaserDistance 300000  // Distance in mircometers (30 cm)
...
#define PressureLED 22  // Green.
#define AngleLED    23  // Red.
#define FireLED     24  // Blue.
// Previous values.
int prevPressure;
int prevAngle;
...
void loop() {
  ...
  while (velocityReadings){
    ...
    // If still within limit...
     if ((velocityStart - falseReadingCheck) < falseReadingDelay) 
    {
